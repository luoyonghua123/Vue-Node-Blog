<template>
  <section>
    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="100">
      ...
      <FormItem label="文章分类" v-if="categoryList.length > 0" prop="category_id">
  ...
  export default {
    ...
    methods: {
     ...
     uploadSuccess(response,file,fileList){
       ...
       const coverUrl=`http://localhost:3001/images/${response.data}`
        ...
        this.$refs[name].validate((valid) => {
          if (valid) {
            // 创建文章
              ...
              this.createArticle(this.formValidate);
