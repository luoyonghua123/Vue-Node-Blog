...
<section class="article-detail">
    <div class="article-container">
        ...
        <ul class="article-intro">
            <li class="articles-item-category">{{category_name}}</li>
            <li>
                <!-- 文章作者 -->
...
export default {
    ...
    created () {
       this._getActicleDetail() ;
    },
    methods:{ 
        ...mapActions({
            getActicleDetail:'article/detail'

       
        }),
        //获取文章详情
        async _getActicleDetail(){
            let res=await this.getActicleDetail({id:this.id})
            const {
                    articleDetail,
                    commentList,
                    comment_pageSize,
            ...
            this.category_name=articleDetail.category_id.name;
